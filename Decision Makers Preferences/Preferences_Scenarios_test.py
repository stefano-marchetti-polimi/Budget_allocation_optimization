...
df.to_csv("DM_Scenarios_Test.csv", index=False)
...
try:
    ...
    _df = pd.read_csv(Path("/mnt/data/DM_Scenarios_Test.csv"))
...
out_name = "weights_vs_year_by_scenario_test.png"
